...
const Registermodal = () => {
    return (
        <div className='w-100 st'>
            ...
            <div
                className="modalbody  position-relative"  >
                <div className='cross'>
                        ...
                        <div className=''>
                            ...
                            <div className='row align-items-center' style={{ paddingLeft: '16px ', paddingRight: '16px' }}>
                                ...
                                <div className='col-lg-5' style={{ fontSize: '13px' }}>
                                    ...
                                    <span className='d-none d-lg-block' style={{ paddingLeft: '80px' }}> Already  have an account ? <span style={{ color: '#2F6CE5' }}> Sign In</span></span>
                                </div>
                            </div>
                            <div className='row ' style={{ padding: '16px 16px' }}>
                                <div className='col-lg-6'>
                                    <div className="d-flex">
                                        <input type="email" className="ps-3 inputfeld2" id="exampleFormControlInput1" placeholder="First Name" />
                                        <input type="email" className="ps-3 inputfeld2" id="exampleFormControlInput1" placeholder="Last Name" />
                                    </div>
                                    <div className="">
                                    ...
                                    <div className=" position-relative" style={{ marginBottom: '19px' }}>
                                        <input type="email" className="ps-3 inputfeld" id="exampleFormControlInput1" placeholder="Password" />  <label for="exampleFormControlInput1" className=" eye2" ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                    ...
                                    <div className='d-flex d-lg-block  justify-content-between '>
                                        ...
                                        <a href="" className='d-block d-lg-none' style={{ color: '#495057' }}>or, Sign In</a>
                                    </div>
                                    <button className=' border border-secondary signinbtn2 align-items-center' style={{ marginBottom: '8px' }}>
                                        <img src={fb} />
                                        <span className='ps-1'> Sign up with Facebook</span></button>
                                    <button className=' signinbtn2 border border-secondary align-items-center'>
                                        <img src={gl} />
                                        <span className='ps-2'> Sign up with Google</span></button>

                                    <p className='secondP d-block d-lg-none'>By signing up, you agree to our Terms & conditions, Privacy policy</p>
