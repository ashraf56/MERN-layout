        ...
        <div className='w-100 st'>
            ...
            <div
                ...
                <Modal.Dialog>
                    ...
                    <Modal.Body>
                        <p className='ptag'>Let's learn, share & inspire each other with our passion for computer engineering. Sign up now 🤘🏼</p>

                        <div className=''>

                            <div className='row align-items-center' style={{ paddingLeft: '16px ', paddingRight: '16px' }}>
                                <div className='col-md-7'>
                                    <h1 className='h01'> Sign In</h1>
                                </div>
                            ...
                            <div className='row ' style={{ padding: '16px 16px' }}>
                                <div className='col-md-6'>
                                    <div class="">
                                        <input type="email" class="form-control inputfeld" id="exampleFormControlInput1" placeholder="Email" />
                                    </div>
                                    <div class=" position-relative" style={{ marginBottom: '19px' }}>
                                        <input type="email" class="form-control inputfeld" id="exampleFormControlInput1" placeholder="Password" />  <label for="exampleFormControlInput1" class=" eye" ><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
